...
namespace CormSquareSupportHub.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private ExternalUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<ExternalUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(ExternalUser)}'. " +
                    $"Ensure that '{nameof(ExternalUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
