console.log("Script starting: tinymce-init.js (v1.1-rev2)");
...
try {
    tinymce.init({
        ...
        toolbar: 'undo redo | blocks fontfamily fontsize | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | numlist bullist indent outdent | table link image media | copycode | code fullscreen',
        ...
        setup: function (editor) {
            ...
            // Debug codesample dialog opening
            editor.on('BeforeExecCommand', function (e) {
                if (e.command === 'mceCodeSample') {
                    console.log('CodeSample dialog opening');
                }
            });

            // Debug codesample insertion
            editor.on('ExecCommand', function (e) {
                if (e.command === 'mceCodeSample') {
                    console.log('CodeSample command executed');
                    console.log('Editor content after CodeSample command:', editor.getContent());
                }
            });
